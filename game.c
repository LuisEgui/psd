...
int
checkUp(tBoard board, unsigned int cell, char c)
{
...
int
checkRight(tBoard board, unsigned int cell, char c)
{
...
int
checkUpLeft(tBoard board, unsigned int cell, char c)
{
...
int
checkUpRight(tBoard board, unsigned int cell, char c)
{
