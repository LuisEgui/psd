...
void
insertChip(xsd__string board, conecta4ns__tPlayer player, unsigned int column)
{
...
int
checkUp(xsd__string board, unsigned int cell, char c)
{
...
int
checkRight(xsd__string board, unsigned int cell, char c)
{
...
int
checkUpLeft(xsd__string board, unsigned int cell, char c)
{
...
int
checkUpRight(xsd__string board, unsigned int cell, char c)
{
...
int
checkWinner(xsd__string board, conecta4ns__tPlayer player)
{
...
void
printBoard(xsd__string board, xsd__string message)
{
...
void
allocClearMessage(struct soap* soap, conecta4ns__tMessage* msg)
{
...
void
allocClearBlock(struct soap* soap, conecta4ns__tBlock* block)
{
  block->code = -1;
